...
public class AQUAS_QuickSetup : EditorWindow {
    ...
    void AddWater()
    {
        ...
        GameObject aquasPrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Prefabs/AQUASWater.prefab", typeof(GameObject));
        ...
        if(targetPlatform == TARGETPLATFORM.desktopWebAndConsole)
        {
            switch (presets)
            {
                case PRESETS.clearLake:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Desktop&Web/Presets/Clear Lake.mat", typeof(Material));
                    break;
                case PRESETS.deepLake:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Desktop&Web/Presets/Deep Lake.mat", typeof(Material));
                    break;
                case PRESETS.swamp:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Desktop&Web/Presets/Swamp.mat", typeof(Material));
                    break;
                case PRESETS.sewer:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Desktop&Web/Presets/Sewer.mat", typeof(Material));
                    break;
                case PRESETS.calmOcean:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Desktop&Web/Presets/Calm Ocean.mat", typeof(Material));
                    break;
                case PRESETS.pondsAndPools:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Desktop&Web/Presets/Ponds & Pools.mat", typeof(Material));
                    break;
                case PRESETS.rtsStyle1:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Desktop&Web/Presets/RTS-Style 1.mat", typeof(Material));
                    break;
                case PRESETS.rtsStyle2:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Desktop&Web/Presets/RTS-Style 2.mat", typeof(Material));
                    break;
            }
        }
        else
        {
            switch (mobilePresets)
            {
                case MOBILEPRESETS.lake:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Mobile/Presets/Mobile Lake.mat", typeof(Material));
                    break;
                case MOBILEPRESETS.swamp:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Mobile/Presets/Mobile Swamp.mat", typeof(Material));
                    break;
                case MOBILEPRESETS.sewer:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Mobile/Presets/Mobile Sewer.mat", typeof(Material));
                    break;
                case MOBILEPRESETS.rtsStyle1:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Mobile/Presets/Mobile RTS 1.mat", typeof(Material));
                    break;
                case MOBILEPRESETS.rtsStyle2:
                    aquasPrefab.GetComponent<MeshRenderer>().sharedMaterial = (Material)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Materials/Water/Mobile/Presets/Mobile RTS 2.mat", typeof(Material));
                    break;
            }
        }
        ...
        else
        {
            ...
            //Add caustics
            GameObject primaryCausticsPrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Prefabs/PrimaryCausticsProjector.prefab", typeof(GameObject));
            GameObject primaryCausticsObj = Instantiate(primaryCausticsPrefab);
            primaryCausticsObj.name = "PrimaryCausticsProjector";
            GameObject secondaryCausticsPrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Prefabs/SecondaryCausticsProjector.prefab", typeof(GameObject));
    ...
    void AddUnderwaterEffects()
    {
        ...
        GameObject underwaterPrefab = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Prefabs/UnderWaterCameraEffects.prefab", typeof(GameObject));
...
#if UNITY_POST_PROCESSING_STACK_V2 && AQUAS_PRESENT
            underwaterObj.GetComponent<AQUAS_LensEffects>().underWaterParameters.underwaterProfile = (PostProcessProfile)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Post Processing/AQUAS_Underwater_v2.asset", typeof(PostProcessProfile));
            underwaterObj.GetComponent<AQUAS_LensEffects>().underWaterParameters.defaultProfile = (PostProcessProfile)AssetDatabase.LoadAssetAtPath("Assets/Downloads/AQUAS/Post Processing/DefaultPostProcessing_v2.asset", typeof(PostProcessProfile));
#endif
